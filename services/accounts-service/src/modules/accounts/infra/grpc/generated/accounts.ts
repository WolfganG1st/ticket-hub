...
import type {
  AccountsServiceClient as _accounts_v1_AccountsServiceClient,
  AccountsServiceDefinition as _accounts_v1_AccountsServiceDefinition,
} from './accounts/v1/AccountsService';
import type {
...
export interface ProtoGrpcType {
  accounts: {
    v1: {
      AccountsService: SubtypeConstructor<typeof grpc.Client, _accounts_v1_AccountsServiceClient> & {
        service: _accounts_v1_AccountsServiceDefinition;
      };
